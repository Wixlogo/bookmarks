...
5. [Photo/Video/Audio Manipulation](#photovideoaudio-manipulation)
    1. [Photo](#photo)
        - [Upscale](#upscale)
        - [Colorize Black and White Pictures](#colorize-black-and-white-pictures)
        - [Background Removers](#background-removers)
    ...
    3. [Audio](#audio)
        - [Upscale](#upscale-1)
        - [Clone](#clone)
6. [Movie/Shows/Anime](#movieshowsanime)
    1. [Movies](#movies)
        - [Streaming](#streaming)
...
7. [Website Tools](#website-tools)
    1. [YouTube](#youtube)
    2. [Reddit](#reddit)
    3. [Price Tracker](#price-tracker)
8. [Books](#books)
9. [Instances - Use Social Media Without Login](#instances---use-social-media-without-login)
    1. [YouTube](#youtube-1)
    2. [Instagram](#instagram)
    3. [Twitter/X](#twitterx)
    4. [Reddit](#reddit-1)
    5. [TikTok](#tiktok)
    6. [Pinterest](#pinterest)
10. [Social Media Downloads](#social-media-downloads)
    1. [YouTube](#youtube-2)
    2. [Instagram](#instagram-1)
    3. [Twitter/X](#twitterx-1)
    4. [TikTok](#tiktok-1)
11. [AI](#ai)
12. [File Sharing](#file-sharing)
    1. [File Hosting](#file-hosting)
        - [Files](#files)
        - [P2P](#p2p)
    2. [CDN](#cdn)
        - [Image CDN](#image-cdn)
        - [Video CDN](#video-cdn)
13. [AI Generation](#ai-generation)
...
17. [Pastebin/Text Editor/Document Editor](#pastebintext-editordocument-editor)
18. [Stock Images](#stock-images)
19. [Games](#games)
    1. [Browser games](#browser-games)
    2. [PC Games](#pc-games)
...
- [t.ly](https://t.ly/tools/link-expander/), [WhereGoes](https://wheregoes.com/) - Un-shorten URLs.
## Temp Verification
...
### Temp CreditCard
- [Cardgen](https://cardgener.com)

---

## Archive Services
- [Wayback Machine](https://web.archive.org/web/20250000000000*/rentry.co/wixlogobookmarks), [Ghost Archive](https://ghostarchive.org/archive/5EC0A)- View Deleted Webpages, Can also Remove Paywalls.
- [Undelete](https://undelete.pullpush.io/) - View Deleted Reddit Posts/Comments: Replace the `www.reddit.com` in the URL with `undelete.pullpush.io`.
...
### Photo
#### Upscale
- [GFPGAN](https://github.com/TencentARC/GFPGAN) - Demo: [Replicate](https://replicate.com/tencentarc/gfpgan), [Huggingface](https://huggingface.co/spaces/Xintao/GFPGAN)
- [IMGUpscaler.ai](https://imgupscaler.ai)  
- [PixNova.ai](https://pixnova.ai/image-upscaler) 
- [Image-upscaling.net](https://image-upscaling.net)  
- [Ilaria_Upscaler](https://huggingface.co/spaces/TheStinger/Ilaria_Upscaler)  
...
#### Background Removers
- [BRIA RMBG](https://briaai-bria-rmbg-2-0.hf.space/) 
- [BG Bye](https://bgbye.io/)
- [PixelCutAI](https://www.pixelcut.ai/)
- [BGBye](https://bgbye.fyrean.com/)
- [remove.bg](https://www.remove.bg)
- [iloveimageUpscaler](https://www.iloveimg.com/remove-background)
...
#### Uncrop
- [Fffiloni](https://huggingface.co/spaces/fffiloni/diffusers-image-outpaint)
- [PixelCutAI](https://www.pixelcut.ai/)

#### Text to Handwriting
- [Free Handwriting Fonts](https://www.quantumenterprises.co.uk/handwriting-fonts/fontvault.htm), [Create your own](https://www.calligraphr.com/en/webapp/app_home/?/)
- [Saurabhdaware.github.io/text-to-handwriting](https://saurabhdaware.github.io/text-to-handwriting/)
- [Texttohandwriting.com](https://texttohandwriting.com/)
- [10015.io](https://10015.io/tools/text-to-handwriting-converter)

### Video
#### Video Upscale
- [Vmakeai](https://vmake.ai/video-enhancer)
...
- [BroadcastAudioUpscaling](https://huggingface.co/spaces/sereich/BroadcastAudioUpscaling)

#### Clone
- [AnyVoiceLab](https://anyvoicelab.com/voice-cloning/)
- [VocalRemover](https://vocalremover.org/) - Song Voice Separation.  
---
...
- [XPrime](https://xprime.tv/), [2](https://xprime.today/)
- [FlixIndia](https://watch.flixindia.site/)


#### Downloading
You can Stream Video Torrents Directly in your Browser using [Instant.io](https://instant.io/) or [BTorrent](https://btorrent.xyz/) or [Magnet Player](https://ferrolho.github.io/magnet-player/)
- [VegaMovies](https://vegamovies.menu/)
- [StarK ClouD](https://pastebin.com/94s2PP4q), [Base64 Decode](https://www.base64decode.org/)
- [1337x Movies](https://1337x.to/movie-library/1/) - Torrent.
- [ExT.to](https://ext.to/browse/?cat=1) - Torrent
- [TamilMV](https://www.1tamilmv.farm/) - Torrent
- [TorrentGalaxy Movies](https://torrentgalaxy.to/torrents.php?parent_cat=Movies) [.onion](http://galaxy3yrfbwlwo72q3v2wlyjinqr2vejgpkxb22ll5pcpuaxlnqjiid.onion/) - Torrent. RIP (


### Shows
#### Streaming
- [Desiseries](https://www.desi-serials.to/)

#### Downloading
Use [VideoDownloadHelper](https://www.downloadhelper.net) on PC and [1DM](https://play.google.com/store/apps/details?id=idm.internet.download.manager) on Android
...
## Website Tools
### Youtube
- [YT Playlist Length](https://ytplaylist-len.sharats.dev/)
- [DownSub](https://downsub.com/) [Tactiq.io](https://tactiq.io/tools/youtube-transcript) - Download Subs/Captions from Video Sites.
- [MORNINGFA·ME](https://morningfa.me/free-ai-prompts/video-summary) - Summarise YouTube video with Your own AI
- [CommentSearch](https://www.commentshark.com/youtube-comment-searcher)
- [YouTube Wrapped](https://videorecap.viewodyssey.com/)

---
### Reddit
- [u/SaveVideo Bot](https://www.reddit.com/user/SaveVideo/): Download Reddit videos- Write `u/SaveVideo` in Comments.
- [u/redditspeedbot/](https://www.reddit.com/user/redditspeedbot/): Change Reddit video speed- Write `u/redditspeedbot speed×` in Comments.
- [u/RecognizeSong](https://www.reddit.com/user/RecognizeSong): Identify Songs in Reddit Video - Write `u/RecognizeSong` in Comments.
- [infini.wtf](https://infini.wtf/) - Reddit Image Search.

---
### Price Tracker
- [PriceHistory](https://pricehistoryapp.com/)
...
### Instagram
- [Imginn](https://imginn.com/dualipa)
- [Dumpor](https://dumpor.io/v/dualipa)
- [Piokok](https://www.piokok.com/profile/dualipa)
- [GramSnap](https://gramsnap.com/en/)

### Twitter/X
- [Nitter](https://nitter.net/DUALIPA) , [Xcancel](https://xcancel.com/DUALIPA)
- [Twstalker](https://twstalker.com/DUALIPA)

### Reddit
- [Redlib](https://redlib.perennialte.ch/r/dualipa) [.onion](http://red.lpoaj7z2zkajuhgnlltpeqh3zyq7wk2iyeggqaduhgxhyajtdt2j7wad.onion/)
- [Proton](https://photon-reddit.com/r/dualipa)
- [RDX](https://rdx.overdevs.com/subreddit.html?r=dualipa)

### TikTok
- [Picuki](https://www.picuki.com/profile/dualipaofficial)
- [UleBird](https://urlebird.com/user/dualipaofficial/)

### Pinterest
[Binternet](https://binternet.revvy.de/) [.onion](http://revznkqdwy7nmlzql66x226g3qnapiooss3rg2uajbj4rypxjnba.b32.i2p/)
...
**Note**: Everything inside will be recorded.
...
### OS
- [OnWorks](https://www.onworks.net/) - Remote Linux VM with internet. Password: `123456`.
- [DaedalOS](https://dustinbrett.com/) - Desktop environment in the browser. 
- [DistroSea](https://distrosea.com/) - Remote Live Linux VM without internet.  
- [anuraOS](https://anura.pro/) - Full-fledged ChromeOS-based operating system in the browser, 1GB download required for Linux emulation.

### IDE
- [Pad.ws](https://pad.ws/) [Source](https://github.com/pad-ws/pad.ws) - Whiteboard as an Full VSCode, draw and fully code in your browser.
...
## Games
### Browser games
- [Poki](https://poki.com/) - Android Games.
- [CrazyGames](https://www.crazygames.com/)
- [Venge.io](https://venge.io/) - FPS Game.
- [Powerline.io](https://powerline.io/) - Multi-Player Snake Game.
- [AbAGames](https://www.asahi-net.or.jp/~cs8k-cyu/browser.html)
- [Plants vs. Zombies](https://plantvszombies.ee/) 
- [TotalJerkFace](https://totaljerkface.com/games.tjf) - Has Happy Wheels.
...
## [Last.fm](https://www.last.fm/user/Wix_logo) Tools
- [Lastguess](https://lastguess.net/) - Lyrics Guessing Game.
- [AlbumIdentify](https://westbrooke117.github.io/AlbumIdentify), [Album-Hangman](https://album-hangman.com)- Album Guessing Game.
- [Nsfcd](https://www.nsfcd.com/lastfm), [SongStitch](https://songstitch.art), [Musicorum](https://www.musicorumapp.com/generate) - Collage Generator.
- [DontDrinkAndRoot](http://lastfm.dontdrinkandroot.net), [Tag Cloud](https://tagcloud.joshuarainbow.co.uk), [Bubbles Last.fm labs](https://www.last.fm/labs/bubbles) - Word Cloud.
- [Lastvmviz](https://lastfmviz.netlify.app), [bijou.fm](https://www.bijou.fm/user/Wix_logo/forever) - Scrobble Analyzer.
- [MainstreamFactor](https://mainstream.ghan.nl), [Taste Overlap](https://7x11x13.xyz/last-fm-overlap/) - Taste Analyzer.
- [Descent Live](https://descent.live/now/Wix_logo/), [Last.fmLive](https://lastfm.live/Wix_logo) - Now Playing.
